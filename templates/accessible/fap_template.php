...
if(!defined('__FAP_TEMPLATE_UTILS__')) {
    ...
    function fap_footer( $tpl ){
        echo '<div class="fap-footer">Questo sito è realizzato da Elena Masia sulla base di  <a target="_blank" href="http://www.joomlafap.it"><span class="icon-joomla">Joomla!FAP </span></a> di Alessando Pasotti  </div>' ;
    }
