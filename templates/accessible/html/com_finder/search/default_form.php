...
jQuery(function() {";
	...
	*/
	...
	var suggest = jQuery('#q').autocomplete({
		serviceUrl: '" . JRoute::_('index.php?option=com_finder&task=suggestions.suggest&format=json&tmpl=component', true) . "',
		paramName: 'q',
		minChars: 1,
		maxHeight: 400,
		width: 300,
...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toURI()); ?>" method="get" class="form-inline">
	...
	<fieldset class="word">
		...
		<?php if ($this->params->get('show_advanced', 1)) : ?>
			<a href="#advancedSearch" class="btn"><span class="icon-list"></span> <?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></a>
		<?php endif; ?>
	</fieldset>
